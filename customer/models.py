...
TYPE = (
    ...
    ("Item Shipped", "Đơn hàng đã gửi đi"),
    ("Item Delivered", "Đơn hàng đã giao"),
)
...
class Address(models.Model):
    ...
    province  = models.CharField(max_length=100, null=True, blank=True, default=None)
    district = models.CharField(max_length=100, null=True, blank=True, default=None)
